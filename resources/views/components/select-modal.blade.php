        ...
        <div
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                    <form action="/submit-resource" method="post" class="flex w-full flex-row justify-between">
                        @csrf
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div class="items-left flex flex-col gap-1">
                                ...
                                <div class="relative py-4">
                                    ...
                                    <input class="flex h-10 rounded-md border px-3 py-2 text-sm w-full pl-8"
                                        id="link" placeholder="Ссылка на ресурс" name="href" value="">
                                </div>
                                <div>
