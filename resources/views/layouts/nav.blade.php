<header class="flex items-center justify-between max-w-[1280px] m-auto">
    ...
    <div class="flex items-center gap-6">
        <a href="/" class="text-slate-500">Спонсоры</a>
        <a href="/" class="text-slate-500">Рассылка</a>
        <a href="/" class="flex items-center gap-2 px-4 py-2 border border-slate-200 rounded-full text-slate-500">
            Добавить ресурс
            <span>→</span>
        </a>
    </div>
